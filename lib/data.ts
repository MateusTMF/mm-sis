...
export const segments: Segment[] = [
  {
    id: 'gesso-3d',
    name: 'MM Gesso 3D',
    title: 'Transforme sua Parede em uma Obra de Arte',
    subtitle: 'Placas de Gesso 3D, Fabricação Própria e Instalação Profissional',
    description: 'A MM Gesso 3D é especializada na fabricação e instalação de placas de gesso 3D decorativas. Transformamos paredes comuns em ambientes modernos, sofisticados e valorizados, com acabamento de alto padrão e excelente custo-benefício. Trabalhamos com fabricação própria, garantindo qualidade, resistência e instalação profissional.',

    services: [
      'Placas de gesso 3D decorativas',
      'Fabricação de placas de gesso 3D',
      'Instalação de gesso 3D',
      'Decoração de paredes com gesso 3D',
      'Projetos personalizados para ambientes residenciais e comerciais',
    ],

    differentials: [
      'Fabricação própria de placas',
      'Acabamento profissional e detalhado',
