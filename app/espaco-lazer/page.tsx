...
export const metadata: Metadata = {
  ...
  description: 'O espaço ideal para transformar momentos especiais em lembranças inesquecíveis. Festas, aniversários e eventos corporativos.',
  openGraph: {
    title: 'MM Espaço & Lazer | Eventos e Confraternizações',
    description: 'O espaço ideal para transformar momentos especiais em lembranças inesquecíveis.',
  },
};
